...
const executeOrder = () => {
	...
	orderStatuses[0].classList.add('btn-light')
	orderStatuses[1].classList.add('btn-light')
	orderStatuses[2].classList.add('btn-light')
	orderStatuses[3].classList.add('btn-light')
	orderStatuses[4].classList.add('btn-light')
	orderStatuses[5].classList.add('btn-light')
	orderStatuses[6].classList.add('btn-light')
	orderStatuses[7].classList.add('btn-light')
	orderStatuses[8].classList.add('btn-light')
	orderStatuses[9].classList.add('btn-light')
